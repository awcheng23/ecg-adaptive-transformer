...
def main():
    ...
    # after training
    # -----------------------
    # Save model state (filter out FLOPs profiling keys)
    state_dict = {k: v for k, v in model.state_dict().items() 
                  if not ('total_ops' in k or 'total_params' in k)}
    torch.save(state_dict, "checkpoints/fixed_transformer.pth")
    print("Model saved to checkpoints/fixed_transformer.pth")
