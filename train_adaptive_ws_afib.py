"""
Train adaptive halting transformer WITHOUT weight sharing on AFIB dataset (Normal vs Abnormal).
This variant uses independent weights for each layer instead of shared weights.
...
def main():
    ...
    model_path = "checkpoints/adaptive_transformer_ws_afib.pth"
    metrics_path = "checkpoints/adaptive_ws_afib_metrics.pt"
    flops_path = "checkpoints/adaptive_ws_flops_per_step_afib.pt"
    flops_path_classwise = "checkpoints/adaptive_ws_flops_per_step_afib_classwise.pt"
    ...
    print("Training complete. Run test_adaptive_ws_afib.py for test metrics.")
