...
from models.big_fixed_transformer import CNNTransformer
...
def main():
    ...
    # config (no argparse)
    # -----------------------
    train_path = "data/db_train_anomaly_30_10.npz"
    val_path   = "data/db_val_anomaly_30_10.npz"

    # model hyperparameters
    seq_len = 3000
    patch_len = 20        # → 150 tokens
    d_model = 192
    n_heads = 6
    num_layers = 6
    dim_ff = 768
    ...
    model_path = "fixed_transformer_30_10.pth"
    ...
    flops_path = "flops_per_step_30_10.pt"
