...
def main():
    ...
    # config
    # -----------------------
    train_path = "data/db_train_anomaly_ind.npz"
    val_path   = "data/db_val_anomaly_ind.npz"
    ...
    model_path = "checkpoints/adaptive_transformer_ind.pth"
    ...
    flops_path = "checkpoints/adaptive_flops_per_step_ind.pt"
